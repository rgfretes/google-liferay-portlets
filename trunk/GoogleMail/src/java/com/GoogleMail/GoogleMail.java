...
/**
 * GoogleMail Portlet Class
 */
public class GoogleMail extends GenericPortlet {
    ...
    public void processAction(ActionRequest request, ActionResponse response) throws PortletException, IOException {
        ...
        try {
            ...
            if (!(token.equals(null)) && !(token.equals("")) && request.getParameter("gmail_tokenauth").equals("true")) {
                secToken = "";
                try {
                    secToken = AuthSubUtil.exchangeForSessionToken("https", "www.google.com", token, keytool.getPrivateKeyAsString());
                } catch (GeneralSecurityException ex) {
                    Logger.getLogger(GoogleMail.class.getName()).log(Level.WARNING, null, ex);
    ...
    public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        actionURL.setParameter("gmail_tokenauth", "true");
        ...
        if (!(secToken.equals(""))) {
            ...
            gcalFeed = gcal.getMailFeed(secToken, privKey, response.getNamespace(), ThemeUtil.ThemePath(request));
        }

        request.setAttribute("Gmail_gcalFeed", gcalFeed);
        request.setAttribute("Gmail_actionURL", actionURL);
        response.setContentType("text/html");
        PortletRequestDispatcher dispatcher =
                getPortletContext().getRequestDispatcher("/WEB-INF/jsp/GoogleMail_view.jsp");
    ...
    public void doEdit(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        response.setContentType("text/html");
        PortletRequestDispatcher dispatcher =
                getPortletContext().getRequestDispatcher("/WEB-INF/jsp/GoogleMail_edit.jsp");
        dispatcher.include(request, response);
    }
    ...
    public void doHelp(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        response.setContentType("text/html");
        PortletRequestDispatcher dispatcher =
                getPortletContext().getRequestDispatcher("/WEB-INF/jsp/GoogleMail_help.jsp");
        dispatcher.include(request, response);
    }
}