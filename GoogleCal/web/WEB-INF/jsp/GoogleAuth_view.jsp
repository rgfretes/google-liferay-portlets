...
String gAuthLink = "";
try {
    actionURL = request.getAttribute("Gcal_actionURL").toString();
    gcalFeed = request.getAttribute("Gcal_gcalFeed").toString();
...
requestURL = AuthSubUtil.getRequestUrl("https", "www.google.com", actionURL , "https://www.google.com/calendar/feeds/", true, true);
...
<span><a href='https://www.google.com/calendar/' target="_blank">Go to Calendar</a></span>
